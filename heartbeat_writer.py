...
launch = date(2026, 5, 15)
days_active = (date.today() - launch).days + 1

content = f"""# Deindex.fyi - Repository Heartbeat
...
| File | Description |
|------|-------------|
| README.md | Main knowledge page about Deindex.fyi |
...
| network/related-sites.md | All related properties |
...
## All URLs (for crawler reference)
...
- Days active since launch: {days_active}
...
print(f"heartbeat.md updated for {today} — day {days_active}")
